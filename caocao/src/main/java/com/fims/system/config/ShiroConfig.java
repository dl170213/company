...
import com.fims.system.shiro.UserRealm;
...
public class ShiroConfig {
   ...
   //     ShiroFilterFactoryBean shiroFilterFactoryBean = new ShiroFilterFactoryBean();
        ...
        filterChainDefinitionMap.put("/exceltemplates/**", "anon");
        ...
        filterChainDefinitionMap.put("/mobile", "anon");//配置APP登录页面不验证
        filterChainDefinitionMap.put("/mobile/pay", "anon");//配置支付页面
        filterChainDefinitionMap.put("/mobile/getPassword", "anon");//配置获取密码
