	...
	if($("#invoicenumber").val()!=""){
        $.ajax({
            ...
            success : function(data) {
                if(data){
                    $('div[name="title_lab"]').removeClass("subscript_warning");
                    $('div[name="title_lab"]').addClass("subscript");
                    $('div[name="title_lab"]').html("新 增");
                }else{
                    $('div[name="title_lab"]').removeClass("subscript");
                    $('div[name="title_lab"]').addClass("subscript_warning");
                    $('div[name="title_lab"]').html("重 复");
                }
            }
        });
	}
